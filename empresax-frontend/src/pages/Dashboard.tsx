  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white shadow-lg rounded-xl p-6">
        <h3 className="text-lg font-semibold mb-4 text-gray-900">Distribui??o por Status</h3>
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie 
                ...
                cy="50%" 
                outerRadius={100} 
                label={(entry: any) => `${entry.name}: ${((entry.value / pieData.reduce((sum, item) => sum + item.value, 0)) * 100).toFixed(1)}%`}
              >
